"""
Django settings for omnus_holdings_41303 project.
...
ROOT_URLCONF = 'omnus_holdings_41303.urls'
...
WSGI_APPLICATION = 'omnus_holdings_41303.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "omnus_holdings_41303 API",
    "DESCRIPTION": "API documentation for omnus_holdings_41303 App",
    "VERSION": "v1",
}
